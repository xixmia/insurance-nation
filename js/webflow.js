...
Webflow.require('ix').init([
  {"slug":"fade-in","name":"fade in","value":{"style":{},"triggers":[{"type":"hover","selector":".overlay","descend":true,"stepsA":[{"opacity":1,"transition":"opacity 300ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 300ms ease 0ms"}]}]}},
  {"slug":"opacity","name":"opacity","value":{"style":{"opacity":0},"triggers":[]}}
]);
